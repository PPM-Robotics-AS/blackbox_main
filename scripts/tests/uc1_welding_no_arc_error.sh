...
NC='\033[0m' # No Color
printf "${GREEN} *** Use-case test 1 - Welding No Arc Error started... *** ${NC}\n"
...
roslaunch blackbox_main test_uc1.launch &
sleep 5
...
pkill -f rostopic
sleep 2
printf "${GREEN}*** Use-case test 1 - Welding No Arc Error finished. All processes killed. *** ${NC}\n"
